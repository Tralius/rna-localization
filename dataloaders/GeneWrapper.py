...
class Gene_Wrapper:
    ...
    path_to_apex_cDNA = "/home/steve/Downloads/apex_rip_cDNA_screened.fa" #os.path.join(basedir, 'Data/apex-rip/apex_rip_cDNA_screened.fa')
    path_to_apex_ann = "/home/steve/Downloads/apex_rip_cDNA_screened.fa" #os.path.join(basedir, 'Data/apex-rip/apex_rip_cDNA_ann_screened.fa')
