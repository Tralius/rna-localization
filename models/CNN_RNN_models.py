...
def m6A_model(max_len, learning_rate=1e-3, dropout_rate=0.4, input_size = 5):
    ...
    e1 = keras.layers.Dense(512, activation='relu')(f)
...
def conv_rnn_struct_ext_bilstm(max_len, learning_rate=1e-3, dropout_rate=0.4, input_size = 4):
    seq_input = Input((max_len, input_size))
    #m6A_input = Input((3,))
    ...
    #lstm1 = keras.layers.Bidirectional(keras.layers.LSTM(units=512, return_sequences=True))(p4)
    #bn1 = keras.layers.BatchNormalization()(lstm1)
    #lrelu = keras.layers.LeakyReLU(alpha=0.05)(bn1)
    #lstm2 = keras.layers.Bidirectional(keras.layers.LSTM(units=512, return_sequences=False))(lrelu)
    #bn2 = keras.layers.BatchNormalization()(lstm2)
    #lrelu2 = keras.layers.LeakyReLU(alpha=0.05)(bn2)
    #d4 = keras.layers.Dropout(dropout_rate)(lrelu2)
    lstm1 = keras.layers.LSTM(units=256)(p4)
    bn1 = keras.layers.BatchNormalization()(lstm1)
    lrelu = keras.layers.LeakyReLU(alpha=0.05)(bn1)
    d4 = keras.layers.Dropout(dropout_rate)(lrelu)
...
def final_struct(max_len, learning_rate=1e-3, dropout_rate=0.2, input_size = 5):
    ...
    lstm1 = keras.layers.LSTM(units=512)(d3)
    #bn1 = keras.layers.BatchNormalization()(lstm1)
    lrelu = keras.layers.ReLU()(lstm1)
    d4 = keras.layers.Dropout(dropout_rate)(lrelu)
